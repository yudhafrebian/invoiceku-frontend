...
const ProductSelectorRecurring: React.FunctionComponent<IProductSelectorProps> = ({
    name,
    placeholder,
    setFieldValue,
    productIndex,
                ...
                {products.map((product) => (
                  <CommandItem
                    ...
                    onSelect={() => {
                      ...
                      setFieldValue(`recurring_invoice_items.${productIndex}.price_snapshot`, product.price);
                    }}
                  >
                    {product.name}
                    <Check
...
export default ProductSelectorRecurring;
