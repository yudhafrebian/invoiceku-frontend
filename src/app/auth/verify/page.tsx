  ...
  return (
    ...
    <Navbar />
      <div className="p-8 shadow-lg w-1/3 m-auto mt-24 border rounded-2xl text-center text-primary">
        ...
        <p className="mt-4 text-muted-foreground">Your account has been successfully verified</p>
        <p className="text-muted-foreground">Go back to website <Link className="hover:text-primary underline" href="/">here</Link></p>
